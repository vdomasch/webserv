...
print ('} else {')
print ('document.getElementById("uploadResult").innerText = "❌ Something went wrong, please try again";')
print ('}')
print ('fileInput.value = "";')
print ('});')
print ('})')
print ('.catch(error => {')
print ('document.getElementById("uploadResult").innerText = "❌ Network Error : " + error;')
print ('});')
print ('}')
print ('</script>')